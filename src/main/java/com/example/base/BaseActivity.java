...
import com.example.backstack.BackStackEntry;
import com.example.backstack.BackStackManager;
...
public abstract class BaseActivity extends AppCompatActivity implements BaseView {
    ...
    protected void attachBaseContext(Context newBase) {
        ...
        String  lang = CommonFunctions.getPreference(newBase, Constants.languageid, "0");

        super.attachBaseContext(LocaleHelper.onAttach(newBase, lang.equalsIgnoreCase("0") ? "en" : "ar"));
